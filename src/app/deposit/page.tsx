    ...
    <div className="page-shell flex flex-col">
      ...
      <main className="relative z-10 mx-auto w-full max-w-3xl flex-1 px-4 pb-16 pt-6 sm:px-6">
        ...
        <section className="card-surface animate-fade-in-up rounded-3xl p-6 sm:p-8">
          ...
          {activeNetwork && (
            <div className="mt-6 flex flex-col items-center gap-5 rounded-2xl border border-white/10 bg-white/[0.03] p-5 sm:flex-row sm:items-center sm:gap-6">
              {activeAddress ? (
                <>
                  ...
                  <div className="min-w-0 flex-1 text-center sm:text-start">
                    ...
                    <p
                      dir="ltr"
                      className="mt-2 break-all rounded-xl border border-emerald-400/30 bg-emerald-500/10 px-3 py-2 font-mono text-sm text-emerald-300"
                    >
          ...
          {errorMessage && (
            <div className="mt-4 rounded-xl border border-rose-400/30 bg-rose-500/10 px-3.5 py-2.5 text-sm text-rose-300">
              {errorMessage}
            </div>
          )}
        </section>
            ...
            {isLoadingHistory ? (
              ...
              <div className="overflow-x-auto">
                <table className="w-full min-w-[640px] text-start text-sm">
                  ...
                  <tbody>
                    {history.map((deposit) => (
                      <tr key={deposit.id} className="border-b border-white/10 last:border-0 hover:bg-white/5/80">
